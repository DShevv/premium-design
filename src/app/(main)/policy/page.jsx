    ...
    <>
      <div className={styles.wrapper}>
        ...
        <section className={styles.text}>
          <h4 className={"h4"}>1. Общие положения</h4>
          ...
          <h4 className={"h4"}>2. Основные понятия, используемые в Политике</h4>
          <p className="body-1-regular">
          ...
          <p className="body-1-regular">
            ...
            с невозможностью дальнейшего восстановления содержания персональн
          </p>
        </section>
      </div>
    </>
