          ...
          <div className={styles.blocks}>
            <div className={styles.item}>
              ...
              <p className={clsx("body-1")}>
                Закупкой и доставкой всех материалов занимается специалист по
                снабжению, который отвечает за графики закупки и коммерческие
                предложения.
              </p>
            </div>
            <div className={styles.item}>
              ...
              <p className={clsx("body-1")}>
                Перед началом ремонта составляется смета с точными объемами и
                расценками. Никаких сюрпризов — вы точно знаете, сколько стоит
                ремонт.
              </p>
            </div>
            <div className={styles.item}>
            ...
            <div className={styles.item}>
              ...
              <p className={clsx("body-1")}>
                ...
                дизайнер, полностью освобождая клиента от организационных
                вопросов и контроля за процессом.
              </p>
            </div>
          </div>
        </div>
